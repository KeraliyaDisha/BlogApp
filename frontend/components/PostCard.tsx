...
<article className="group bg-white rounded-lg overflow-hidden border border-gray-100 shadow-md hover:shadow-xl transition-all duration-300 max-w-[290px] flex flex-col h-full">
        ...
        {post.author && post.author.image && (
          <div className="flex items-center mt-auto pt-4 border-t border-gray-100">
            ...
            <Link
              ...
              className="ml-auto flex items-center text-blue-900 font-medium text-sm group-hover:text-blue-600 transition-colors duration-200"
            >
              Read More
              <svg
